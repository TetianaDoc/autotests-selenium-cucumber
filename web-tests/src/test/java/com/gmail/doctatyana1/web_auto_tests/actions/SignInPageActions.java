 ...
 */
@Slf4j
public final class SignInPageActions extends BasePageActions implements PageAction {
    ...
    public boolean isLogoImgEnabled() {
        return page.getLogoImg().isEnabled();
    }
    ...
    public boolean isHomeButtonEnabled() {
        return page.getHomeButton().isEnabled();
    }

    public boolean isAboutUsButtonEnabled() {
        return page.getAboutUsButton().isEnabled();
    }
