...
class SignUpPageTest extends BaseTest {
  ...
  void shouldProperDisplayAllElementsOnSignUpPage() {
    ...
    assertThat(signUpActions.isIconDisplayed()).isTrue();
    assertThat(signUpActions.isRestorePasswordLinkEnabled()).isTrue();
    assertThat(signUpActions.isSelectLanguageButtonEnabled()).isTrue();
    assertThat(signUpActions.isSelectedPackageButtonEnabled()).isTrue();
    assertThat(signUpActions.isEyeIconEnabled()).isTrue();
    assertThat(signUpActions.isProgramVersionDisplayed()).isTrue();
    assertThat(signUpActions.isCookieConsentDisplayed()).isTrue();
    assertThat(signUpActions.isConfirmCookieButtonEnabled()).isTrue();
    assertThat(signUpActions.isSupportButtonEnabled()).isTrue();
